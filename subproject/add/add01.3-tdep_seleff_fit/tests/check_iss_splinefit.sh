...
expect_grep 'BUILD_RATIO_HIST_ISS' "${MAIN_FILE}" "missing raw ISS/MC ratio histogram builder"
...
expect_grep 'TH1D \*hratio' "${MAIN_FILE}" "missing raw ISS/MC ratio histogram"
...
expect_grep 'Write\(\"hratio\"' "${MAIN_FILE}" "missing raw ISS/MC ratio histogram write"
