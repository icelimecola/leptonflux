...
TH1D *_calcMCAcc(TString fnm, TString fnm_gen, int icut, double emin, double emax, double nplane=1.0){
	//======== geoacc
...
int main(){
	...
	TString fname_mc[1][2] = {
		...
		"./datain/ncc.root","./datain/mchgen.root"
	};
	//============init
	double emin,emax;
	emin = 0.25, emax = 200;
	...
	// 	}
	// 	else{
	// 		hacc[i] = _calcFoldedAcc( fname_mc[0][1], fname_mc[0][0], i, emin, emax, fout );
	...
	cc_ene->SetStats(0);
	cc_ene->SetNameTitle("cc_ene", "cc_ene");
